      ...
      <div className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-homemade-apple-pie"
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-tres-leche-cake"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-german-chocolate-cake"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-oatmeal-raisin-cookies"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-oatmeal-chocolate-chip-cookie"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-strawberry-cheesecake"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-classic-chocolate-chip-cookie"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-macarons"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <Link
              to="/recipes/dessert-foods-homemade-strawberry-icecream"
              className="text-blue-500 hover:text-blue-700"
            >
              <img
