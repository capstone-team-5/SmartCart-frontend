...
const SpicedCreamOfWheatPorridgeRecipeComponent = ({
  ...
  return (
    <div className="bg-white p-4 shadow-md rounded-lg">
      <h3 className="text-2xl font-semibold mb-4">Spiced Cream of Wheat Porridge</h3>
      <img
      ...
      <div className="recipe">
        ...
        <ol className="list-decimal pl-6 mb-4">
          <li>
            <strong>Step 1:</strong> In a saucepan, bring the milk to a boil.
          </li>
          <li>
            <strong>Step 2:</strong> Gradually whisk in the cream of wheat,
            sugar, ground cinnamon, and ground nutmeg.
          </li>
          <li>
            <strong>Step 3:</strong> Reduce heat to low and simmer, stirring
            constantly, until the porridge thickens, about 5-7 minutes.
          </li>
          <li>
            <strong>Step 4:</strong> Remove from heat and stir in the vanilla
            extract and raisins.
          </li>
          <li>
            <strong>Step 5:</strong> Serve the spiced cream of wheat porridge
            hot.
          </li>
        </ol>
      </div>
