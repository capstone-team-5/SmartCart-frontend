...
const Bakery = ({ addToCart }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API}/products/bakery`, {
          params: {
  ...
  return (
    <div className="sm:px-8 md:px-24 py-12 dark:bg-gray-900">
      <div className="flex flex-col dark:bg-gray-900">
        <div className="bg-transparent bg-cover bg-[url(https://www.chabaso.com/wp-content/uploads/2018/11/Group-8-1400x759.jpg)] bg-gray-700 bg-blend-multiply ">
