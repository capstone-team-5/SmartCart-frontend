...
const Dairy = ({ addToCart }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API}/products/dairy`, {
          params: {
  ...
  return (
    <div className="sm:px-8 md:px-24 py-12 dark:bg-gray-900">
      <div className="flex flex-col dark:bg-gray-900">
        <div className="bg-transparent bg-cover bg-[url(https://i.pinimg.com/1200x/8d/62/64/8d6264ce57e8dab6881863951c33116e.jpg)] bg-gray-700 bg-blend-multiply ">
