...
const Nuts = ({ addToCart }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API}/products/nuts`, {
          params: {
  ...
  return (
    <div className="sm:px-8 md:px-24 py-12 dark:bg-gray-900">
      <div className="flex flex-col dark:bg-gray-900">
        <div className="bg-transparent bg-cover bg-[url(https://www.shutterstock.com/image-photo/mixed-nuts-like-walnut-pistachio-260nw-1463584241.jpg)] bg-gray-700 bg-blend-multiply ">
